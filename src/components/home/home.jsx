    ...
    <main className="home">
      <div id="topo" className="sobre-nos">
        <div className="descricao">
          ...
          <p>
            ...
            mas onde estará o palácio se não o fizerem ali?Agir, eis a
            inteligência verdadeira. Serei o que quiser. Mas tenho que querer o
            que for. O êxito está em ter êxito, e não em ter condições de êxito.
            Condições de palácio tem qualquer terra larga, mas onde estará o
            palácio se não o fizerem ali?Agir, eis a inteligência verdadeira.
            Serei o que quiser. Mas tenho que querer o que for. O êxito está em
            ter êxito, e não em ter condições de êxito. Condições de palácio tem
            qualquer terra larga, mas onde estará o palácio se não o fizerem
            ali?Agir, eis a inteligência verdadeira. Serei o que quiser. Mas
      ...
      <div id="contato" className="contato">
        ...
        <div className="conteudo-contato">
          <div className="info">
            <p>
              <span>Endereço:</span> Marcodes Salgado 12-52
            </p>
            <p>
              <span>Telefone:</span> (14) 99199-7620
            </p>
            <p>
              <span>Email:</span> contato@chococream.com.br
            </p>
            <div className="redes-socias">
              <a
                href="https://www.facebook.com/chococream.bauru"
                target="blank"
              >
                <img src={icoFacebook} alt="Acessar o Facebook" />
              </a>
              <a
                href="https://www.instagram.com/chococream.bauru/"
                target="blank"
              >
                <img src={icoInstagram} alt="Acessar o Instagram" />
              </a>
              <a
                href="https://api.whatsapp.com/send?phone=5514991997620"
                target="blank"
              >
